package com.track.social.gautam.socialtracker;
...
// Initializes latestOccurrence , short est SubarrayLength , and keywordToIdx.
        ...
        int shortetDistance = Integer.MAX_VALUE;
        ...
        for (int i = 0; i < paragraph.size(); ++i) {
            ...
            if (keywordldx != null) {
                ...
                if (keywordldx == keywords.size() - 1 && shortestSubarrayLength.get(shortestSubarrayLength.size() - 1) < shortestDistance) {
